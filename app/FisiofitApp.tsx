...
export default function FisiofitApp() {
  ...
  const [agendaMode, setAgendaMode] = useState<"week" | "team">("week");
    ...
    <main className="app-shell">
      ...
      <section className="workspace">
        <header className="topbar">
          <div className="mobile-brand"><span className="brand-mark">f</span><strong>Fisiofit</strong></div>
...
function Agenda({ mode, setMode, setModal, flash }: { mode: "week" | "team"; setMode: (m: "week" | "team") => void; setModal: (m: "appointment" | "evolution") => void; flash: (s: string) => void }) {
  ...
  return <div className="content">
    ...
    <div className="toolbar">
      <div className="segmented"><button className={mode === "week" ? "selected" : ""} onClick={() => setMode("week")}>Semana</button><button className={mode === "team" ? "selected" : ""} onClick={() => setMode("team")}>Equipe hoje</button></div>
      ...
      <label className="mini-select">Profissional: <select><option>Marina Souza</option><option>Camila Oliveira</option><option>Todos</option></select></label>
    </div>
    ...
    </section> : <section className="team-day card">
