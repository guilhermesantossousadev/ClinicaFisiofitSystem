...
const LinksPage = () => (
  <main className="min-h-screen bg-gradient-to-br from-sky via-white to-mint px-5 py-8">
    <div className="mx-auto max-w-md text-center">
      <Link to="/" aria-label="Voltar ao site" className="grid h-11 w-11 place-items-center rounded-full bg-blue text-white transition-colors duration-200 hover:bg-blue-dark active:bg-navy"><ArrowLeft size={20} /></Link>
